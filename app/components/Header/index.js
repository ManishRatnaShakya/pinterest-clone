  ...
  return (
    <div className="navbar">
      ...
      <a href="/saved">
        <img
          className="icon"
          src="https://thumbs.dreamstime.com/b/saved-vector-icon-isolated-white-background-outline-thin-line-saved-icon-website-design-mobile-app-development-thin-189434346.jpg"
          alt="no "
        />
      </a>
      <a>
